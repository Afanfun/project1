          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{active:saleAttrValue.isChecked==1}" v-for="(saleAttrValue,index) in spuSaleAttr.spuSaleAttrValueList" :key="saleAttrValue.id" @click="changeActive(saleAttrValue,spuSaleAttr.spuSaleAttrValueList)">{{saleAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
    ...
    methods: {
      ...
      async addShopCar(){
        ...
        try {
          ...
          // 产品信息数据[较复杂:skuInfo],通过会话存储(不持久化,会话结束消失)
          // 本地存储|会话存储,一般存储字符串
